...
const MobileHomeUI = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="w-full bg-[#fff3fa] pt-9 rounded-t-3xl border-t-2 border-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),0_-2px_4px_-2px_rgba(0,0,0,0.1),inset_0_2px_4px_rgba(255,255,255,0.1)]">
        {/* Quick Access Cards */}
        <div className="px-10 mb-8">
          <div className="grid grid-cols-2 gap-7">
            <Link to="/used-cars" className="block">
            <Card className="border border-white bg-[#fffbfe] rounded-t-xl shadow-[0_0_10px_rgba(0,0,0,0.1),inset_0_2px_4px_-2px_rgba(255,255,255,0.1)]">
