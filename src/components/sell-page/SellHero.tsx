...
interface SellHeroProps {
  ...
  children: ReactNode;
  isManualEntryClicked: boolean; // New prop to track if manual entry was clicked
}
...
const SellHero: React.FC<SellHeroProps> = ({
  ...
  // Define card styles based on whether manual entry was clicked
  const cardStyles = isManualEntryClicked 
    ? { width: '586.98px', height: '646.4px' } 
    : {};
  ...
  return (
    <section className="relative w-full z-10 min-h-[100dvh] lg:min-h-[950px] xl:min-h-[800px] 2xl:min-h-[850px] flex items-stretch transition-colors duration-500">
      ...
      <div 
        ...
        style={{
          backgroundImage: isDarkMode
            ...
            : `url(https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)`
        }}
      />
      ...
      {/* Main container */}
      <div className="relative z-20 flex flex-col md:flex-row container max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-12 items-center md:items-stretch w-full gap-2 md:gap-4">
        {/* Left side: Content */}
