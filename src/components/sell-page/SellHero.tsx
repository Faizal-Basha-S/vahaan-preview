...
const SellHero: React.FC<SellHeroProps> = ({
  ...
  return (
    <section className="relative w-full z-10 min-h-[100dvh] lg:min-h-[950px] xl:min-h-[800px] 2xl:min-h-[850px] flex items-stretch transition-colors duration-500">
      ...
      {/* Main container */}
      <div className="relative z-20 flex flex-col md:flex-row container max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-12 items-center md:items-stretch w-full gap-2 lg:gap-4">
        {/* Left side: Content */}
