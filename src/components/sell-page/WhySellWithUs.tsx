...
const heroImageUrl = "https://plus.unsplash.com/premium_photo-1661906789703-a25a1e53180e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
...
,
  ...
  {
    title: "Verified & Listed for Free",
    description:
      "Our team reviews your information to ensure accuracy. Once verified, your car and bike is listed on the platform for free and shared with verified buyers and dealer partners.",
    icon: (
  <span className="flex items-center justify-center w-10 h-10 rounded-full bg-[#FFF0E7] border border-[#ffd1b0]">
    {/* Shield check icon */}
    <svg width="24" height="24" fill="none" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
