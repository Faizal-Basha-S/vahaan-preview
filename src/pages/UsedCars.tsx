    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="w-full">
            ...
            <Carousel className="w-full overflow-visible">
              <CarouselContent className="">
                ...
                <CarouselItem key={car.id} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-4"> {/* Add internal padding to reveal shadows */}
                      <CarCard car={car} />
                    </div>
                  </CarouselItem>
                ))}
          ...
          <section className="mb-12 px-4">
  <div className="flex justify-between items-center mb-6">
    <h2 className="text-2xl font-bold">Discounted Cars</h2>
    <Link to="/search" className="text-blue-600 dark:text-blue-400 hover:underline">
      View All
    </Link>
  </div>
  ...
  <Carousel className="w-full overflow-visible">
    <CarouselContent className="">
      {mockCarListings.slice().reverse().map(car => (
        <CarouselItem key={`discount-${car.id}`} className="md:basis-1/2 lg:basis-1/3">
          <div className="p-4"> {/* Add padding to make shadow fully visible */}
    ...
    <div className="hidden md:flex justify-end gap-2 mt-4 px-2">
      ...
      <CarouselNext className="static translate-y-0" />
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-6">Browse by Body Type</h2>
          ...
          <section className="mb-8 text-center">
            <div className="bg-orange-100 dark:bg-orange-900/30 rounded-xl p-8">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">Browse our extensive collection of quality used cars and find the perfect match for your needs and budget.</p>
              <Link to="/search">
