...
  </>
                  ...
                  {data.rto_state === "Jammu and Kashmir" && (
  <>
...
  </>
                  ...
                  {data.rto_state === "Himachal Pradesh" && (
  <>
...
  </>
                  ...
                  {data.rto_state === "Dadra and Nagar Haveli" && (
  <>
    <SelectItem value="DN-09">DN-09</SelectItem>
  </>
)}
                  {data.rto_state === "Daman and Diu" && (
  <>
...
  </>
                  ...
                  {data.rto_state === "Arunachal Pradesh" && (
  <>
...
/>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <input 
                  type="checkbox" 
                  id="terms-agreement"
                  checked={data.terms_agreement || false}
              ...
              <div className="flex items-center gap-2">
                <input 
                  ...
                  checked={data.privacy_agreement || false}
                  onChange={(e) => handleInputChange("privacy_agreement", e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                />
              ...
              <div className="flex items-center gap-2">
                <input 
                  type="checkbox"
                  id="data-agreement"
                  checked={data.data_agreement || false}
                  onChange={(e) => handleInputChange("data_agreement", e.target.checked)}
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                />
                <label htmlFor="data-agreement" className="text-sm">
  ...
  const renderStepSeven = () => {
    return (
      <div className="space-y-6">
        <h3 className="text-lg font-medium">Payment & Listing</h3>
        
        <Pricing 
          onBack={handleBack}
          expectedPrice={expectedPrice || stepData[4]?.seller_price || "0"}
