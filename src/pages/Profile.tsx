          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
              ...
              <Button 
                ...
                className={`${phoneUpdated ? 'bg-green-500 hover:bg-green-600' : ''} transition-colors duration-300`}
                type="button"
              >
                {phoneUpdated ? <Check className="mr-1 h-4 w-4" /> : null}
                Save Phone
              </Button>
            </div>
            <p className="text-sm text-muted-foreground mt-1">
              Please enter 10 digits without country code
            </p>
          </div>
